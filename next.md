...
| `UCI_Elo` 3000 | **5.0s** | **v22 32g 35.9%**; **v23 T=2 37.5%**; **T=4 probe 12.5%** (avoid); **v25 book** running |
...
- **v25 book:** drop London-as-White + `1.d4 e6`; add French Classical/Advance as Black — match running
