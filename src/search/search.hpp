...
private:
  ...
  Value draw_score(const Position& pos) const;
  ...
  Value rootScore = 0; // last completed iteration score (root STM)
  static constexpr int DrawContempt = 18; // cp: root side dislikes sterile draws
};
